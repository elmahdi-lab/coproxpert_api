...
func (m *CredentialMutation) SetScope(value map[string]interface{}) {
	m.scope = &value
}

// Scope returns the value of the "scope" field in the mutation.
func (m *CredentialMutation) Scope() (r map[string]interface{}, exists bool) {
	v := m.scope
	if v == nil {
		return
	}
...
// If the Credential object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *CredentialMutation) OldScope(ctx context.Context) (v map[string]interface{}, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *CredentialMutation) SetRights(value map[string]interface{}) {
	m.rights = &value
}

// Rights returns the value of the "rights" field in the mutation.
func (m *CredentialMutation) Rights() (r map[string]interface{}, exists bool) {
	v := m.rights
	if v == nil {
		return
	}
...
// OldRights returns the old "rights" field's value of the Credential entity.
// If the Credential object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *CredentialMutation) OldRights(ctx context.Context) (v map[string]interface{}, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldRights is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
		return v, errors.New("OldRights requires an ID field in the mutation")
	}
	oldValue, err := m.oldValue(ctx)
	if err != nil {
		return v, fmt.Errorf("querying old value for OldRights: %w", err)
	}
	return oldValue.Rights, nil
}

// ResetRights resets all changes to the "rights" field.
func (m *CredentialMutation) ResetRights() {
	m.rights = nil
}
...
func (m *CredentialMutation) Fields() []string {
	...
	if m.rights != nil {
		fields = append(fields, credential.FieldRights)
	}
	if m.created_at != nil {
...
func (m *UserMutation) SetCredentialID(id uuid.UUID) {
	m.credential = &id
}
...
func (m *UserMutation) CredentialID() (id uuid.UUID, exists bool) {
	if m.credential != nil {
